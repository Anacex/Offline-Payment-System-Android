...
class Wallet(Base):
    ...
    # Demo field for "current" wallets; offline wallets may omit at creation time.
    bank_account_number = Column(String(64), nullable=False, default="N/A", server_default="N/A")
